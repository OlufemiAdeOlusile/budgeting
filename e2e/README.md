...
# A SIMPLE TEST PLAN AND CYPRESS AUTOMATION FOR E2E TESTS: BUDGETING APP
...
### To Run
Note that test run on http://localhost:8000/, to change please override "baseUrl" in cypress.json
...
- `npm run cy:run-dashboard`  - runtTest headless with dashboard for test html report
